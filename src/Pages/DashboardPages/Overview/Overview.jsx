                ...
                {stats.map((item, index) => (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-start relative z-10 mb-8">
                            ...
                            <div className={`flex items-center gap-1 font-black italic text-[10px] px-3 py-1.5 rounded-full uppercase tracking-tighter ${
                                item.isLoss ? 'bg-red-50 text-red-600' : 'bg-primary/10 text-primary'
                            }`}>
